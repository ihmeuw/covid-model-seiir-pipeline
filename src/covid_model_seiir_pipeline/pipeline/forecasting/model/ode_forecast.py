...
from covid_model_seiir_pipeline.pipeline.forecasting.model.ode_systems import (
    seiir_system,
    vaccine_system,
    variant_natural_system,
    variant_implicit_system,
    variant_explicit_system,
)
...
class _ODERunner:
    systems: Dict[str, Callable] = {
        'normal': seiir_system,
        'vaccine': vaccine_system,
        'variant_natural': variant_natural_system,
        'variant_explicit': variant_explicit_system,
        'variant_implicit': variant_implicit_system,
    }
    ...
    def get_solution(self, initial_condition, times, parameters):
        ...
        if 'variant' in self.scenario_spec.system:
            system_params.append(
                parameters[self.parameters_map['variant_prevalence']],
            )
