...
def evil_doings(data: pd.DataFrame, hierarchy: pd.DataFrame, input_measure: str) -> Tuple[pd.DataFrame, Dict]:
    ...
    if input_measure == 'cases':
        ...
        dated_drop_list = [
            ...
            (500, 'hebei', '2022-08-26'),
            (501, 'heilongjiang', '2022-08-27'),
            (502, 'henan', '2022-08-27'),
            (500, 'hebei', '2022-08-26'),
            (503, 'hubei', '2022-08-09'),
            (505, 'inner_mongolia', '2022-08-23'),
            (509, 'liaoning', '2022-08-23'),
            (511, 'qinghai', '2022-08-11'),
            (512, 'shaanxi', '2022-08-12'),
            (515, 'shanxi', '2022-08-17'),
            (516, 'sichuan', '2022-08-21'),
            (517, 'tianjin', '2022-08-25'),
            (518, 'tibet', '2022-08-27'),
            (519, 'xinjiang', '2022-07-31'),
            (169, 'c_a_r', '2022-03-19'),
        ]
